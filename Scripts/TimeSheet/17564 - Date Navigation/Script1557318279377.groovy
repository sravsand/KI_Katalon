...
//Test Step
Rep.nextTestStep("Ensure Timesheet Entry screen displaying [The Current Week] by default")
	String timesheetWeek = WebUI.getText(findTestObject(Const.timesheet + 'timesheetWeek'))
	def thisWeek = Com.weekDates()
	gAct.compareStringAndReport(thisWeek, timesheetWeek)
	

//Test Step
Rep.nextTestStep("Navigate Toggle Date Navigation - Previous week")
...
//Test Step
Rep.nextTestStep("Navigate Toggle Date Navigation - next week")
