...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String[] newDeliverable = [DeliverableName, GVars.user, "Project Innovation_" + GVars.selectedBrowser, deliverableType.name, endDate]
...
Rep.nextTestStep("Verify error")
	...
	if(modalError){
		...
		gAct.findSubstringInStringAndReport(errtext, "At least one Deliverable refers to it")
	}
...
Rep.nextTestStep("Verify the [deliverableType] still exists in the table")
	sVal.searchTableAddedValue(3, deliverableType.name)
