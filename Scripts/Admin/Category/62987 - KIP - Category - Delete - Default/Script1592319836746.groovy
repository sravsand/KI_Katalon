...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	component.createCategoryDefault(category)
...
Rep.nextTestStep("Verify the warning message to read as [This expense category is currently set as the default. Please make another expense category the default before attempting to delete.]")
	...
	if(errMess){
		...
		gAct.findSubstringInStringAndReport(errMessage, "It is not possible to delete the default Category '" + categoryName + "'")
	}
