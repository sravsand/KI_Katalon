...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String[] newCategory = [categoryName, categoryCode, null]
...
Rep.nextTestStep("Verify the [Active] checkbox is deselected")
	gObj.elementPresentSync(Const.kip4Generic + "chk_Active")
	def active = WebD.getCheckBoxState("//input[@id='active']")
	gAct.compareStringAndReport(active, null)
	
	
Rep.nextTestStep("Hover mouse over and attempt click on 'Default Category' checkbox")
	def defCat = WebD.getCheckBoxState("//input[@id='defaultCategory']")
	gAct.compareStringAndReport(defCat, null)
	gObj.verifyAttributeSync(Const.kip4Category + 'chkbx_DefaultCategory', "disabled")
