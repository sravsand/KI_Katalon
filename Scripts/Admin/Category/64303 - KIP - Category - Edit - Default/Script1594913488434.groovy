...
Rep.nextTestStep("Click on 'Default Category' checkbox")
	gObj.elementPresentSync(Const.kip4Category + "chk_DefaultCategory_edt")
	def defCat = WebD.getCheckBoxState("//input[@id='defaultCategory']")
	if(defCat == null){
		gObj.buttonClickSync(Const.kip4Category + 'chk_DefaultCategory_edt')
	}
