...
Rep.info("~~~~~~~~~~~~~~~~~~~~~")
	...
	gObj.refreshUI()
	sVal.searchTableDeletedValue(2, benefitTypeNameNew)
	
	rowNo = sVal.searchTableReturnRow(3, benefitType.name)
	gObj.buttonClickSubIntPosSync(Const.columnPicker + 'inlineEdit_Alt', rowNo, "row")
	gObj.selectInlineOption(1)
Rep.info("~~~~~~~~~~~~~~~~~~~~~")
...
Rep.nextTestStep("Verify the chagnes are updated accurately and the selected Benefit Type is marked as active on the Benefit Type table")
	...
	gAct.compareStringAndReport(newActiveStatus, "No")
