...
Rep.nextTestStep("Updating existing [Name] to new value")
	gObj.setEditSync(Const.kip4Generic + "input_Name", clonedClientGroupName)
...
Rep.nextTestStep("Verify the changes are updated accurately on the Client Group table")
	sVal.searchTableAddedValue(3, clonedClientGroupName)	
