...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String[] newResource = ["Dave_" + ResourceName, "Employee", "KIP Dev Team 1", "KIP 1 Team Lead", "Cleckheaton", "Full Time Calendar (My Region)", costCentre.name, "Martin Phillips", "AutoTest@Workflows.com", "", "100", "", "", "", "", "", resourceNotes]
...
Rep.nextTestStep("Click onto [Inline menu] against a cost centre")
...
Rep.nextTestStep("Verify the [cost] still exists in the table")
	sVal.searchTableAddedValue(3, costCentre.name)
