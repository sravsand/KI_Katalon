...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String[] newCost = [costName, costCode, "17.00", "Both", "Default Currency"]
	...
	String[] newResource = ["Dave_" + ResourceName, "Employee", "KIP Dev Team 1", "KIP 1 Team Lead", "Cleckheaton", "Full Time Calendar (My Region)", costCentreNew, "Martin Phillips", "AutoTest@Workflows.com", "", "100", cost.name, cost.name, "", "", "", resourceNotes]
...
Rep.nextTestStep("Verify the [cost] still exists in the table")
	gObj.buttonClickSync(Const.columnPicker + "a_New Filter")
	gObj.buttonClickSync(Const.columnPicker + "a_Search")
	sVal.searchTableAddedValue(3, cost.name)
