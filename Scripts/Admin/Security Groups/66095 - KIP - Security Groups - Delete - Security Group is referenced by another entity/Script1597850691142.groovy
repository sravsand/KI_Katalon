...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	component.createLogin(login, "Administration_Alt")
	
	component.addSecurityGroupToLogin(login, securityGroup.code)
...
Rep.nextTestStep("Verify the [Security Group] still exists in the table")
	sVal.searchTableAddedValue(3, securityGroup.name)
