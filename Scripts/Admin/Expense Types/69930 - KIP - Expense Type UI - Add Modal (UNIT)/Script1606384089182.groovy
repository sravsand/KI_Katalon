...
Rep.nextTestStep("Click over [Currency] dropdown")
	gObj.buttonClickSync(Const.kip4ExpenseType + "dropDown_CurrencyAlt")
	gObj.setEditSync(Const.kip4ExpenseType + "input_CurrencyAlt", expenseType.currency)
	gAct.milliWait(500)
...
Rep.nextTestStep("Set [Cost Per Currency] value ")
	gObj.setEditSync(Const.kip4ExpenseType + "input__unitCost", expenseType.rate)
	
		
Rep.nextTestStep("Set [Cost Per Currency] value ")
	gObj.setEditSync(Const.kip4ExpenseType + "input__singleUnitLabel", expenseType.name)

	
Rep.nextTestStep("Set [Cost Per Currency] value ")
	gObj.setEditSync(Const.kip4ExpenseType + "input__PluralUnitLabel", expenseType.name)
	
	
Rep.nextTestStep("Set [Multiple Expense Value] value ")
	gObj.scrollToElementSync(Const.kip4ExpenseType + "input__multipleExpense")
	gObj.setEditSync(Const.kip4ExpenseType + "input__multipleExpense", expenseType.rate)
