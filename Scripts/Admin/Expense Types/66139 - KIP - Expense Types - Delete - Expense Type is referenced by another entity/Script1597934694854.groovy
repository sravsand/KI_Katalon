...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String[] newExpense = [GVars.user, newDate, "KIPDEV1", "DEFAULT", "PRJ017", expenseType.code , category.code, true, "16.00", "", "16.00", false, expenseNotes]
...
Rep.nextTestStep("Verify the [deliverableType] still exists in the table")
	sVal.searchTableAddedValue(3, expenseType.name)
