...
Rep.nextTestStep("Click onto [Inline menu] against a currency")
	...
	int rowNo = sVal.searchTableReturnRow(2, currValue)
...
Rep.nextTestStep("Click [Delete]")
	...
	if(errMess){
		...
		gAct.findSubstringInStringAndReport(errMessage, "Default Currency cannot be deleted:")
	}
	
	
Rep.nextTestStep("Click [Cancel]")
	gObj.buttonClickSync(Const.kip4DeleteModal + "button_Cancel")
	sVal.searchTableAddedValue(2, currValue)
