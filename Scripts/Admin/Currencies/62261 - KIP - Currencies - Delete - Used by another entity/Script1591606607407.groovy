...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String[] newExpenseType = [expenseName, expenseCode, currency.name, "1", "true", "9.00"]
...
Rep.nextTestStep("Click onto [Inline menu] against a currency")
	...
	int rowNo = sVal.searchTableReturnRow(2, currency.code)
...
Rep.nextTestStep("Click [Delete]")
	...
	if(errMess){
		...
		gAct.findSubstringInStringAndReport(errMessage, currencyName + " cannot be deleted:")
		gAct.findSubstringInStringAndReport(errMessage, "At least one Expense Type refers to it")
	}
