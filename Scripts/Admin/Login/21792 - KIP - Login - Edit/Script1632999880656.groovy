...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String firstName2 = Com.generateRandomText(6)
	String surname2 = Com.generateRandomText(7)
	String EdtName =  firstName2 + " " + surname2
...
Rep.nextTestStep("Click onto [Inline menu] of Logins")
...
Rep.nextTestStep("Change name")
	gObj.scrollToElementSync(Const.kip4Login + "label_Name")
	gObj.setEditSync(Const.kip4Login + "input_Name", EdtName)
...
Rep.nextTestStep("Verify the newly added Expense Type is added onto the table")
	gObj.createNewFilter("Login Name", "=", EdtName)
	sVal.searchTableAddedValue(3, EdtName)
