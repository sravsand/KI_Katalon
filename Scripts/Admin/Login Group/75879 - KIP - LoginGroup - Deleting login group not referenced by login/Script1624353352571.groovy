...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String[] newLoginGrp = [loginGrpName, loginGrpCode, "", "", "", "All Actions", "", "A line manager is notified when a subordinate submits a Timesheet"]
...
Rep.nextTestStep("Verify the toaster message to read as [Deleted Successfully]")
	Act.verifyDeletePopUpText()
	
	
Rep.nextTestStep("Verify the deleted login group is not available for selection in login group table")
	sVal.searchTableDeletedValue(3, loginGroup.name)
