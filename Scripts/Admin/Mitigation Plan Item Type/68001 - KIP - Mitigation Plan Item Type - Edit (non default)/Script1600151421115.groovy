...
Rep.nextTestStep("Verify the chagnes are updated accurately and the selected Mitigation Plan Item Type is marked as active on the Mitigation Plan Item Type table")
