...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String[] newCostCentreCF = [costCentreCFName, "Keywords", "Normal", "", ""]
	CostCentreCustomField costCentreCustomField = GenerateCostCentreCustomField.createCostCentreCustomField(newCostCentreCF)
	createCF.costCentreCustomField_Keywords(tabName, costCentreCustomField, allowedName, "Blue")
...
Rep.nextTestStep("Select the inline menu of the relevant [Cost Centre] and select New Open")
...
Rep.nextTestStep("Ensure the previously saved option in the Keywords is displayed")
	String cfVal = gObj.getEditTextSync(Const.kip4CostCentre + "customField_Keyword")
	gAct.compareStringAndReport(cfVal, allowedName)
