...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	createCF.costCentreCustomField_Keywords(tabName, costCentreCustomField, "", "")
...
Rep.nextTestStep("In the Add textfield of the Dynamic Keywords [Custom Field], enter a value, then click 'Add to List'")
	gObj.buttonClickSync(Const.kip4CostCentre + "a_btnAddDynKey")
	gObj.setEditSync(Const.kip4CostCentre + "input_newDynKeyword",allowedName)
	gObj.buttonClickSync(Const.kip4CostCentre + "btn_AddDynKeyModal")

	
Rep.nextTestStep("Select Dynamic Keywords dropdown")
	gObj.buttonClickSync(Const.kip4CostCentre + "customField_Keyword")

	
Rep.nextTestStep("Ensure recently added option value has been added")
	gObj.elementPresentSubSync(Const.kip4CostCentre + "select_CFKeyword", allowedName, "cfkey")
