...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String falseActivity = Com.generateRandomText(10)
...
Rep.nextTestStep("Scroll down through entities")


Rep.nextTestStep("Enter valid search characters in the Textfield of the EntityPicker")
	gObj.setEditSync(Const.kip4CostCentre + "input_EntityPicker", activity.name)
	gObj.buttonClickSubSync(Const.kip4CostCentre + "select_EntityPicker", activity.name, "value")
	
	
Rep.nextTestStep("Enter invalid search characters in the Textfield of the EntityPicker")
	gObj.buttonClickSync(Const.kip4CostCentre + "dropDown_CFKeywordExisitngValue")
	gObj.setEditSync(Const.kip4CostCentre + "input_EntityPickerHasValue", falseActivity)
	gObj.elementPresentSync(Const.kip4CostCentre + "select_EntityNoItemsFound")
