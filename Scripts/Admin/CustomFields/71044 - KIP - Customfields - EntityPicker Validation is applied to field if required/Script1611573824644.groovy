...
Rep.nextTestStep("If the EntityPicker is REQUIRED and nothing is selected")
	...
	gObj.buttonClickSubSync(Const.kip4CostCentre + "header_Modal", "Edit Cost Centre", "title")
	gObj.elementPresentSync(Const.kip4CostCentre + "errorMsg_This field is required")
	

Rep.nextTestStep("Attempt to enter an invalid search term and move focus")
	gObj.buttonClickSync(Const.kip4CostCentre + "dropDown_CFKeyword")
	gObj.setEditSync(Const.kip4CostCentre + "input_CustomfieldExistingVal", "fefsdfatb")
	gObj.elementPresentSync(Const.kip4CostCentre + "error_NoItemsFound")
