...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String[] newCostCentreCF = [costCentreCFName, "Boolean", "Normal", GuidenceNotes, ""]
...
Rep.nextTestStep("Ensure 'SummerNotes' have the Info icon to the left of the label")
	gObj.buttonClickSubSync(Const.kip4CostCentre + "costCentreGuidanceNotes_ChkBox_InTab", costCentreCustomField.guidanceNotes, "tip")
