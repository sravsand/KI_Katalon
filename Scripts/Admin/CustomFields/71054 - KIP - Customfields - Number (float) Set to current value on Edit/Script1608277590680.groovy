...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String defVal = "100001"
	
	ComCF.deleteAllCustomField(tableName, "Cost Centre")
	
	String[] newCostCentreCF = [costCentreCFName, "Float", "Normal", "", defVal]
...
Rep.nextTestStep("Ensure value of the [Customfield] matches that of the value of the [Cost Centre] being edited")
	String actDefVal = gObj.getAttributeSync(Const.kip4CostCentre + "input_Customfield_InTab", 'value')
	gAct.compareStringAndReport(actDefVal, defVal)
