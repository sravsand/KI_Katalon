...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String[] newCostCentreCF = [costCentreCFName, "Existing Values", "Normal", GuidenceNotes, ""]
...
Rep.nextTestStep("Ensure 'existing values' has the Info icon to the left of the label")
	if(GVars.browser == "Firefox"){
		WebD.clickElement("//i[@class='fa fa-info-circle tooltip-info ng-star-inserted']")
	}else {
		gObj.buttonClickSubSync(Const.kip4CostCentre + "costCentreGuidanceNotes_ExistingVal_InTab", costCentreCustomField.guidanceNotes, "tip")
	}
