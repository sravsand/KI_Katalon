...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String[] newCostCentreCF = [costCentreCFName, "Dynamic Keywords", "Read Only On Amend", "", ""]
	...
	component.costCentreWithDynamicCustomField(costCentre, tabName, allowedName)
...
Rep.nextTestStep("Ensure Dynamic Keywords field is readonly")
	boolean visObj = gObj.verifyAttributeSync(Const.kip4CostCentre + "input_Cust", 'readonly')
	String keywordActVal = gObj.getEditTextSubSync(Const.kip4CostCentre + "input_DynCustfield", allowedName, "text")
	gAct.compareStringAndReport(keywordActVal, allowedName)
