...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String[] newCostCentreCF = [costCentreCFName, "Existing Values", "Read Only On Amend", "", ""]
...
Rep.nextTestStep("Ensure Email field is readonly")
	gObj.verifyAttributeSubSync(Const.kip4CostCentre + "input_ExValCustfield", ReadOnlyAmendVal, "text", 'readonly')
	String actVal = gObj.getEditTextSubSync(Const.kip4CostCentre + "input_ExValCustfield", ReadOnlyAmendVal, "text")
	gAct.compareStringAndReport(actVal, ReadOnlyAmendVal)
