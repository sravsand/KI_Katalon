...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String readOnlyVal = Com.generateRandomText(6)
	
	ComCF.deleteAllCustomField(tableName, "Cost Centre")
	
	String[] newCostCentreCF = [costCentreCFName, "Keywords", "Read Only", "", readOnlyVal]
	...
	createCF.costCentreCustomField_Keywords(tabName, costCentreCustomField, readOnlyVal, "Green")
...
Rep.nextTestStep("Ensure Keywords field is readonly")
	gObj.verifyAttributeSync(Const.kip4CostCentre + "Input_CustomAlt", 'disabled')
	String keywordActVal = gObj.getEditTextSync(Const.kip4CostCentre + "Input_CustomAlt")
	gAct.compareStringAndReport(keywordActVal, readOnlyVal)
