...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String[] newCostCentreCF = [costCentreCFName, "Number List", "Normal", "", "1"]
	CostCentreCustomField costCentreCustomField = GenerateCostCentreCustomField.createCostCentreCustomField(newCostCentreCF)
	String allowedName = 1
	createCF.costCentreCustomField_Keywords(tabName, costCentreCustomField, allowedName, "Red")
...
Rep.nextTestStep("Ensure Values and Colours match that of the [Custom Field] Keywords, as defined in Config->Custom Fields->[Custom Field]")

	gObj.buttonClickSync(Const.kip4CostCentre + "DropDown_NumList")
	String colourValue = gObj.getAttributeSync(Const.kip4CostCentre + "CFColour_dot", 'style')
	gAct.compareStringAndReport(colourValue, "background-color: rgb(255, 0, 0);")
