...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String[] newCostCentreCF = [costCentreCFName, "Activity", "Normal", GuidenceNotes, ""]
...
Rep.nextTestStep("Ensure 'Entity Picker' have the Info icon to the left of the label")
