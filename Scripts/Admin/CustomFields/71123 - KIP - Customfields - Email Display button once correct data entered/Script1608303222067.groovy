...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String email = randName + "@coldmail.com"
	...
	String[] newCostCentreCF = [costCentreCFName, "Email", "Normal", "", ""]
...
Rep.nextTestStep("Enter a valid email address and click SAVE")
	gObj.setEditSync(Const.kip4CostCentre + "input_Customfield", email)
	gObj.elementVisibleSync(Const.kip4CostCentre + "a_Email")
	WebUI.verifyElementClickable(findTestObject(Const.kip4CostCentre + "a_Email"))

	
Rep.nextTestStep("Delete the Email Address and click SAVE")
	gObj.clearText(Const.kip4CostCentre + "input_Customfield")
	WebUI.verifyElementNotVisible(findTestObject(Const.kip4CostCentre + "a_Email"), FailureHandling.OPTIONAL)
