...
Rep.nextTestStep("Edit a [Short Text] default value ")
	gObj.setEditSync(Const.kip4CostCentre + "input_Customfield", costCentreName)
...
Rep.nextTestStep("Verify Short Text is displaying the updated text")
