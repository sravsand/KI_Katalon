...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	def today = new Date()
	def newDate = Com.increaseWorkingCalendarWithFormat(today, 4, "dd/MM/yyyy")
	...
	String[] newCostCentreCF = [costCentreCFName, "Date", "Read Only", "", newDate]
...
Rep.nextTestStep("Ensure Default value of the [Customfield] is displayed")
	boolean visObj = gObj.verifyAttributeSync(Const.kip4CostCentre + "input_DatePicker", 'readonly')
	String cfVal = gObj.getAttributeSync(Const.kip4CostCentre + "input_DatePicker", 'value')
	gAct.compareStringAndReport(cfVal, costCentreCustomField.defaultValue)
