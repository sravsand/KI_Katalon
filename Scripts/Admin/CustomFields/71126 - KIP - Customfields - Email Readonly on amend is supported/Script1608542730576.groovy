...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String ReadOnlyVal = Com.generateRandomText(4) + "@testMail.com"
	
	ComCF.deleteAllCustomField(tableName, "Cost Centre")
	
	String[] newCostCentreCF = [costCentreCFName, "Email", "Read Only", "", ReadOnlyVal]
	...
	String ReadOnlyWeb = "www." + Com.generateRandomText(4) + ".com"
	String[] newCostCentreCF_Int = [newCostCentreCFName, "URL", "Read Only", "", ReadOnlyWeb]
...
Rep.nextTestStep("Ensure Email field is readonly")
	gObj.verifyAttributeSync(Const.kip4CostCentre + "input_Customfield", 'readonly')	
	String emailActVal = gObj.getAttributeSync(Const.kip4CostCentre + "input_Customfield", 'value')
	gAct.compareStringAndReport(emailActVal, ReadOnlyVal)
	
	
Rep.nextTestStep("Ensure URL field is readonly")
	gObj.verifyAttributeSync(Const.kip4CostCentre + "input_Customfield2", 'readonly')
	String urlActVal = gObj.getAttributeSync(Const.kip4CostCentre + "input_Customfield2", 'value')
	gAct.compareStringAndReport(urlActVal, ReadOnlyWeb)	
