...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String formatedText = Com.generateRandomText(4) + " " + Com.generateRandomText(7) + " " + Com.generateRandomText(5)
	
	String[] newCostCentreCF = [costCentreCFName, "Formatted Text", "Normal", "", ""]
...
Rep.nextTestStep("Enter text in text area")
	gObj.setEditSync(Const.kip4CostCentre + "FormattedTextField_EditableArea_InTab_unExpanded", formatedText)
//	gObj.buttonClickSync(Const.kip4CostCentre + "FormattedTextField_EditableArea_InTab_unExpanded")
//	gObj.buttonClickSync(Const.kip4CostCentre + "FormattedTextField_EditableArea_InTab")
//	gObj.setEditSync(Const.kip4CostCentre + "FormattedTextField_EditableArea_InTab", formatedText)
	

Rep.nextTestStep("Format text")
	Rep.info("Third party software doesn't require testing")
...
Rep.nextTestStep("Select New OPEN for newly created [Cost Centre]")
...
Rep.nextTestStep("Ensure text previously formatted retains formatting")
	gObj.buttonClickSubSync(Const.kip4CostCentre + "newTab", tabName, "tab")
	Rep.info("Third party software doesn't require testing")
