...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String[] newCostCentreCF = [costCentreCFName, "Text", "Normal", "Guidance Note", ""]
...
Rep.nextTestStep("Ensure 'Text' text editor is displayed")
...
Rep.nextTestStep("Ensure 'Text' have the Info icon to the left of the label")
