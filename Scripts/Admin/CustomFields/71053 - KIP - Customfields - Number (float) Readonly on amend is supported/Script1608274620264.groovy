...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String[] newCostCentreCF = [costCentreCFName, "Float", "Read Only On Amend", GuidenceNotes, ""]
	...
	component.costCentreWithCustomField(costCentre, tabName, "1234")
...
Rep.nextTestStep("Ensure Number field is readonly")
	gObj.verifyAttributeSync(Const.kip4CostCentre + "input_Customfield_InTab", 'readonly')
