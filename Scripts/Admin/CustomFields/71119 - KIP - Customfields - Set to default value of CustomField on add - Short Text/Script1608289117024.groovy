...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String[] newCostCentreCF = [costCentreCFName, "Short Text", "Normal", "Guidance Note", "This is Default Text"]
...
Rep.nextTestStep("Ensure 'Short Text' text editor is displayed")
	gObj.elementPresentSubSync(Const.kip4CostCentre + "label_Customfield_InTab", costCentreCustomField.name, "obj")
	gObj.elementPresentSync(Const.kip4CostCentre + "ShortTextField")
	
	
Rep.nextTestStep("Verify Default Text is displayed accurately")
	String dValue = gObj.getAttributeSync(Const.kip4CostCentre + "ShortTextField", 'value')

	gAct.compareStringAndReport(dValue, costCentreCustomField.defaultValue)
