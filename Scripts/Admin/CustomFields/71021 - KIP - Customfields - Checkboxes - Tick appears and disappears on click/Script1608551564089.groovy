...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	createCF.costCentreCustomField_CheckBox(tabName, costCentreCustomField, true)
...
Rep.nextTestStep("If checkbox is CHECKED by default, uncheck it")
	...
	if(active){
		gObj.buttonClickSubSync(Const.kip4CostCentre + "chkBox_Customfield_InTab", costCentreCustomField.name, "chk")
	}
	
	active = WebD.getCheckBoxState("//input[@id='cf116']")
	gAct.compareStringAndReport(active, null)
	
	
Rep.nextTestStep("If checkbox is UNCHECKED by default, check it")
	gObj.buttonClickSubSync(Const.kip4CostCentre + "chkBox_Customfield_InTab", costCentreCustomField.name, "chk")
	active = WebD.getCheckBoxState("//input[@id='cf116']")
	gAct.compareStringAndReport(active, "true")
