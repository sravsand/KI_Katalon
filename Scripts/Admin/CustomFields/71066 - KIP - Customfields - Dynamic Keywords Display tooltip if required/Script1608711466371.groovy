...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String[] newCostCentreCF = [costCentreCFName, "Dynamic Keywords", "Normal", GuidenceNotes, ""]
...
Rep.nextTestStep("Ensure 'dynamic keywords' have the Info icon to the left of the label")
	if(GVars.browser == "Firefox"){
		WebD.clickElement("//i[@class='fa fa-info-circle tooltip-info ng-star-inserted']")
	}else {
		gObj.buttonClickSubSync(Const.kip4CostCentre + "costCentreGuidanceNotes_DynKeyword_InTab", costCentreCustomField.guidanceNotes, "tip")
	}
