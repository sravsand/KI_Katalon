...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String newDepartmentName = Com.generateRandomText(10)
	String newDepartmentCode = newDepartmentName.toUpperCase()
	...
	component.createDepartment(department)
...
Rep.nextTestStep("Click onto [Inline menu]of a Departments")
	gObj.createNewFilter("Department Name", "=", department.name)
...
Rep.nextTestStep("Enter code in [New Code] textbox")
	gObj.setEditSync(Const.kip4CodeConverter + "input_newCode", newDepartmentCode)
...
Rep.nextTestStep("Verify that the changes have been updated in expense type table")
	sVal.searchTableAddedValue(2, newDepartmentCode)
