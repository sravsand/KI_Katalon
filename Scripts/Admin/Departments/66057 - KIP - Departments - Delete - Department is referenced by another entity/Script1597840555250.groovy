...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String[] newResource = ["Dave_" + ResourceName, "Employee", department.name, "KIP 1 Team Lead", "Cleckheaton", "Full Time Calendar (My Region)", costCentreNew, "Martin Phillips", "AutoTest@Workflows.com", "", "100", "", "", "", "", "", resourceNotes]
...
Rep.nextTestStep("Verify the [cost] still exists in the table")
	sVal.searchTableAddedValue(3, department.name)
