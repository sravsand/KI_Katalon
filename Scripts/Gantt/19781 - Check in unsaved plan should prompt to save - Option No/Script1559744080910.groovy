...
Rep.nextTestStep("Amend any existing task")
	gAct.Wait(3)
	String itemName = "Deployment Complete"
	String newItemName = "Deployment Updated"
	ganttPop.updateCell(9, 3, 3, newItemName)
...
Rep.nextTestStep("Verify the changes are saved correctly in checked in plan")
	String taskVal = WebUI.getText(findTestObject(Const.ganttTable + 'ganttRow', [('task'): itemName]))
	gAct.compareStringAndReport(taskVal, itemName)
