...
Rep.nextTestStep("Click on [...] from menu bar ")
	...
	WebUI.click(findTestObject(Const.columnPicker + "a_Column Chooser"))
	gAct.Wait(2)
	WebUI.dragAndDropToObject(findTestObject(Const.columnPicker + "col_Active"), findTestObject(Const.columnPicker + "col_Absence"))
