...
Rep.nextTestStep("Click on [Save] or [Save & Close] button")
	...
	gAct.compareStringAndReport(errorMsg, "Unable to Save Cost Centre")
	
	
Rep.nextTestStep("Add text in [Name] field")
	WebUI.setText(findTestObject(Const.columnPicker + "input_Name"), costCentre.name)
	
	
Rep.nextTestStep("Add [Code]")
	WebUI.setText(findTestObject(Const.columnPicker + "input_Code"), costCentre.code)
...
Rep.nextTestStep("Verify the newly added Cost Centre is added onto the table")
