...
String locationName = Com.generateRandomText(5)
String locationCode = locationName.toUpperCase()

String downloadPath = "C:\\Katalon Studio\\KeyedInProjects\\downloads\\KIP_Location_DataLoad.xls"
...
Rep.nextTestStep("Fill the [Mandatory] fields in spreadsheet")
	eAct.writeToCellInExcelXLS(downloadPath, searchItem, 10, 1, locationCode)
	eAct.writeToCellInExcelXLS(downloadPath, searchItem, 10, 2, locationName)
...
Rep.nextTestStep("Verify the recently upload data is available for selection in Activity table")
	sVal.searchTableAddedValue(2, locationCode)
