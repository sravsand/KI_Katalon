...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String NewProjectCode = Com.generateRandomText(5).toUpperCase()
...
Rep.nextTestStep("Enter code in [New Code] textbox")
	gObj.setEditSync(Const.columnPicker + "input_NewCode", NewProjectCode)
...
Rep.nextTestStep("Verify that the changes have been updated in expense type table")
	gObj.buttonClickSync(Const.columnPicker + "a_New Filter")
	gObj.buttonClickSync(Const.columnPicker + "a_Search")
	sVal.searchTableAddedValue(3, NewProjectCode)
