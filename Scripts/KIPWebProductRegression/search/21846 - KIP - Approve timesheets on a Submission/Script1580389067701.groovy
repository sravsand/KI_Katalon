...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String[] newHours = ["8.00", notes, "7.00", notes, "7.00", notes, "8.00", notes, "8.00", notes, "", "", "", ""]
...
Rep.nextTestStep("Select the [Timesheets] user want to approve through checkbox")
	WebUI.uncheck(findTestObject(Const.columnPicker + "chk_TimesheetApprovalModalRow", [('row'): 1]))
	WebUI.uncheck(findTestObject(Const.columnPicker + "chk_TimesheetApprovalModalRow", [('row'): 4]))
	WebUI.uncheck(findTestObject(Const.columnPicker + "chk_TimesheetApprovalModalRow", [('row'): 5]))
...
Rep.nextTestStep("Verify the approved hours breakdown are updated within the [View Submission] modal ")
	...
	gAct.compareStringAndReport(actApproved, "14:00")
...
Rep.nextTestStep("Verify any [Unapproved] hours breakdown is correct within the [View Submission] modal")
	...
	gAct.compareStringAndReport(actUnapproved, "24:00")
