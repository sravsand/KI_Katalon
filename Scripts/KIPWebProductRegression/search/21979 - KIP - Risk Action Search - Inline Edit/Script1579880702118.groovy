...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String newDueDate = Com.increaseWorkingCalendarWithFormat(today, 8, pattern)
...
Rep.nextTestStep("Change the expected resolution date")
	gObj.setEditSync(Const.columnPicker + "input_inLineDueDate", newDueDate)
...
Rep.nextTestStep("Verify that the changes are saved ")
	...
	gAct.compareStringAndReport(ActiveStatus_new, newDueDate)
