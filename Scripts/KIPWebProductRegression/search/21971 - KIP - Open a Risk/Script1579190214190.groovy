...
Rep.nextTestStep("Change the date in [Expected Resolution Date]")
	gObj.setEditSync(Const.risks + 'input_ImpactDate', endDate)
...
Rep.nextTestStep("Verify that the Risk table updated with new expected resolution date")
	String Active_new = gObj.getEditTextDblSubIntPosSync(Const.columnPicker + "searchTable", rowNo, "row",  4, "col")
	gAct.compareStringAndReport(Active_new, endDate)
