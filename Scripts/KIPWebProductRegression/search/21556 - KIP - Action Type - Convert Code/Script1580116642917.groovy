...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String newActionName = Com.generateRandomText(10)
	String newActionCode = newActionName.toUpperCase()
...
Rep.nextTestStep("Click onto [Inline menu]of an Action Types")
...
Rep.nextTestStep("Enter code in [New Code] textbox")
	gObj.setEditSync(Const.columnPicker + "input_NewCode", newActionCode)
...
Rep.nextTestStep("Click on [Close]")
	...
	gObj.refreshUI()
	gObj.elementPresentSync(Const.columnPicker + "a_Search")


Rep.nextTestStep("Verify that the changes have been updated in expense type table")
	sVal.searchTableAddedValue(2, newActionCode)
