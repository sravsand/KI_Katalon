...
Rep.nextTestStep("Click onto [Refuse Payment]")
	gObj.buttonClickSubIntPosSync(Const.columnPicker + "a_ViewInline", 3, "pos")

	
Rep.nextTestStep("Select [Payment Refused] from [Payment Status] dropdown menu")
	gObj.selectComboByLabelSync(Const.columnPicker + "select_PaymentStatus", "Payment Refused")
...
Rep.nextTestStep("Verify the status of the claim under [Payment] as [Paid]")
	...
	gAct.compareStringAndReport(paymentStatus, "Refused")
...
Rep.nextTestStep("Verify the amount of the claim under [Paid Amount]")
	...
	gAct.compareStringAndReport( paidAmt, "£0.00")
