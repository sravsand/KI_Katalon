...
String searchItem = "Benefit Types"
String searchVal = "Benefit Type"
...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String clonedBenefitTypeName = Com.generateRandomText(10)
	String clonedBenefitTypeCode = clonedBenefitTypeName.toUpperCase()
	
	String[] clonedBenefitType = [clonedBenefitTypeName, clonedBenefitTypeCode, "Financial"]
	BenefitType newClonedBenefitType = GenerateBenefitType.createBenefitType(clonedBenefitType)
...
Rep.nextTestStep("Amend text in [Name] field")
	WebUI.setText(findTestObject(Const.columnPicker + "input_Name"), newClonedBenefitType.name)

	
Rep.nextTestStep("Add text in [Code] field")
	WebUI.setText(findTestObject(Const.columnPicker + "input_Code"), newClonedBenefitType.code)
...
Rep.nextTestStep("Verify the cloned [Activity] is available for selection in the table")
	sVal.searchTableAddedValue(3, newClonedBenefitType.name)
