...
Rep.nextTestStep("Click on [Save] or [Save & Close] button")
	...
	gAct.compareStringAndReport(errorMsg, "Unable to Save Skill")
...
Rep.nextTestStep("Enter a number in [Minimum Level] field")
	WebUI.setText(findTestObject(Const.columnPicker + "input_MinLevel"), skill.minLevel)
	
	
Rep.nextTestStep("Enter a number in [Maximum Level] field")
