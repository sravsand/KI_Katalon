...
Rep.nextTestStep("Select [Login Groups] from search filter")
	...
	gAct.Wait(1)
	Boolean valueBefore = WebUI.verifyElementNotPresent(findTestObject(Const.columnPicker + "header_Active"), GVars.midWait)
...
Rep.nextTestStep("Click on [...] from menu bar ")
	...
	Boolean value2After = WebUI.verifyElementPresent(findTestObject(Const.columnPicker + "header_Active"), GVars.midWait)
