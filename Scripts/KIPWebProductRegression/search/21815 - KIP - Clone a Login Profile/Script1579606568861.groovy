...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String clonedLoginProfileName = Com.generateRandomText(8)
	String clonedLoginProfileCode = clonedLoginProfileName.toUpperCase()
	
	String[] newClonedLoginProf = [clonedLoginProfileName, clonedLoginProfileCode]
	LoginProfile clonedLoginProfile = GenerateLoginProfile.createLoginProfile(newClonedLoginProf)
...
Rep.nextTestStep("Select [Login Profiles] from dropdown list")
...
Rep.nextTestStep("Amend text in [Name] field")
	WebUI.setText(findTestObject(Const.columnPicker + "input_Name"), clonedLoginProfile.name)
	
	
Rep.nextTestStep("Add text in [Code] field")
	WebUI.setText(findTestObject(Const.columnPicker + "input_Code"), clonedLoginProfile.code)
...
Rep.nextTestStep("Verify the cloned [Activity] is available for selection in the table")
	sVal.searchTableAddedValue(3, clonedLoginProfile.name)
