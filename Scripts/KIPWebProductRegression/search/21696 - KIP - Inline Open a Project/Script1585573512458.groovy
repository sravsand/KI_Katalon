...
Rep.nextTestStep("Click over any project hyperlink")
	gObj.buttonClickSync(Const.columnPicker + "a_New Filter")
	gObj.buttonClickSync(Const.columnPicker + "a_Search")
	int rowNo = sVal.searchTableReturnRow(4, project.name)
	gObj.buttonClickSubSync(Const.columnPicker + "a_ProjectHyperLink", project.name, "link")
	
	String header = gObj.getEditTextSync(Const.columnPicker + "ProjectHeader")
	gAct.findSubstringInStringAndReport(header, project.name)
