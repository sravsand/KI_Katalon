...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String notes = "Test view timesheet - 21848"
...
Rep.nextTestStep("Select [Disapprove] from [Operation] dropdown")
	gObj.selectComboByLabelSync(Const.columnPicker + "select_Operation", "Unapprove")
...
Rep.nextTestStep("Click [Unapprove] button")
	gObj.buttonClickSync(Const.columnPicker + "button_Unapprove_TimesheetApprovalModal")
	gAct.Wait(GVars.shortWait)
