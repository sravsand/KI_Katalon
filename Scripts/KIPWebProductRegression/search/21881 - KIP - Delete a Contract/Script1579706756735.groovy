...
Rep.nextTestStep("Click onto [Inline menu] of an Contract")
	int rowNo = sVal.searchTableReturnRow(3, contract.name)
	String key = gObj.getEditTextDblSubIntPosSync(Const.columnPicker + "searchTable", rowNo, "row", 2, "col")
...
Rep.nextTestStep("Verify that the deleted expense type is not available for selection")
	sVal.searchTableDeletedValue(3, contract.name)
