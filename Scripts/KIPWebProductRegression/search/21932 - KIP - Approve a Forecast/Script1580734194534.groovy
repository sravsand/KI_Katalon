...
Rep.nextTestStep("Click onto [Approve]")
	gObj.buttonClickSubIntPosSync(Const.columnPicker + "a_InlineMenuPositionSelection", 2, "pos")
	
	
Rep.nextTestStep("Click onto [Approve] button within modal window")
...
Rep.nextTestStep("Verify the status of the Forecast change as [Live]")
	WebUI.refresh()
	gAct.Wait(GVars.shortWait)
	...
	gAct.compareStringAndReport(newStatus, "Live")
