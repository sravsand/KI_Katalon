...
Rep.nextTestStep("Click onto [Inline menu] of a Locations")
...
Rep.nextTestStep("Amend text in [Name] field")
	WebUI.setText(findTestObject(Const.columnPicker + "input_Name"), clonedLocation.name)

	
Rep.nextTestStep("Add text in [Code] field")
	WebUI.setText(findTestObject(Const.columnPicker + "input_Code"), clonedLocation.code)
...
Rep.nextTestStep("Verify the cloned [Locations] is available for selection in the table")
	sVal.searchTableAddedValue(3, clonedLocation.name)
