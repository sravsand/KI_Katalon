...
String searchVal = "Timesheet Submission"
...
Rep.nextTestStep("Click on [...] from menu bar ")
	...
	gAct.Wait(2)
	WebUI.dragAndDropToObject(findTestObject(Const.columnPicker + "col_Key"), findTestObject(Const.columnPicker + "col_Resource"))
