...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String[] newAssignment = ["project_asgds", "Development", ProjectDescription, GVars.user, "KIP Dev Team 1", todaysDate, "8:00", endDate, "16:00", "100"]
...
Rep.nextTestStep("Click on checkbox of a Assignments")
...
Rep.nextTestStep("Click onto [Revert to Role] button")
	gObj.buttonClickSync(Const.columnPicker + 'a_RevertToRole')
	
	
Rep.nextTestStep("btn_OK_Revert")
