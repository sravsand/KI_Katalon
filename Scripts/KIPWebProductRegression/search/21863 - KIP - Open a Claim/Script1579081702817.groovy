...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String refNo = component.createClaim(claim)
...
Rep.nextTestStep("Click onto [Open]")
	gObj.buttonClickSync(Const.columnPicker + "a_Open_Claim")

	
Rep.nextTestStep("Click onto all the tabs and verify the details are correct")
	WebUI.verifyTextPresent(claim.resource, false)
	WebUI.verifyTextPresent(claim.date, false)
	WebUI.verifyTextPresent("£" + expenseVal, false)
