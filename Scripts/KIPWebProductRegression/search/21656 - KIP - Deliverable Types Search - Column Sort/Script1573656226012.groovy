...
Rep.nextTestStep("Click on [Project] from menu bar")
	...
	if(matchCode){
		Rep.pass("Project has been sorted correctly.")
	}else{
		Rep.fail("Project has not been sorted correctly.")
	}
...
Rep.nextTestStep("Click on [Name] from menu bar")
	...
	if(match){
		...
		Rep.fail("Name has not been sorted correctly.")
	}
