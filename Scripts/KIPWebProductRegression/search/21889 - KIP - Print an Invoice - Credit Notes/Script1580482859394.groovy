...
Rep.nextTestStep("KIP - V6 Stage Login page")
	...
	String downloadFile = "C:\\Katalon Studio\\KeyedInProjects\\downloads\\Invoices.pdf"
...
Rep.nextTestStep("Click onto [Print]")
	...
	if(file.exists()){
		Rep.pass("File downloaded correctly")
	}else{
		Rep.fail("File not downloaded correctly")
	}
