...
Rep.nextTestStep("Tick the checkbox from [Action] column")
	WebD.clickElement("//div[@id='f290c391-05b9-4c04-897d-423b39da36f9']/div[5]/table/tbody/tr [" + rowNo + "]/td[4]/div/label/span")
	gAct.Wait(1)
	
	
Rep.nextTestStep("Click on [Floppy Icon] to save the changes")
	WebD.clickElement("//div[@id='f290c391-05b9-4c04-897d-423b39da36f9']/div[5]/table/tbody/tr[" + rowNo + "]/td/div/a/i")
	gAct.Wait(1)
