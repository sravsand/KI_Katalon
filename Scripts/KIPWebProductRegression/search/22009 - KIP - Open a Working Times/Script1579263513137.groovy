...
Rep.nextTestStep("Click onto [Inline menu] of Working Times")
	int rowNo = sVal.searchTableReturnRow(3, workingTimes.title)
	gObj.buttonClickSubIntPosSync(Const.columnPicker + 'inlineEdit_Alt', rowNo, "row")
	
	
Rep.nextTestStep("Click onto [Open]")
	gObj.buttonClickSubSync(Const.columnPicker + "a_Open_WorkingTimes", workingTimes.code, "code")
	

Rep.nextTestStep("Click [Save and Close]")
	gObj.buttonClickSync(Const.columnPicker + "button_CloseWorkingTimes")
