...
Rep.nextTestStep("Select [Departments] from search filter")
	...
	Boolean valueBefore = WebUI.verifyElementNotPresent(findTestObject(Const.columnPicker + "header_Department Manager"), 5)
	gAct.Wait(2)
...
Rep.nextTestStep("Click on [...] from menu bar ")
	...
	gAct.Wait(2)
	WebUI.dragAndDropToObject(findTestObject(Const.columnPicker + "col_DepartmentManger"), findTestObject(Const.columnPicker + "col_ParentDepartment"))
	gObj.buttonClickSync(Const.columnPicker + "button_Save")
	
	Boolean value2After = WebUI.verifyElementPresent(findTestObject(Const.columnPicker + "header_Department Manager"), 5)
