...
Rep.nextTestStep("Select [Locations] from search filter")
...
Rep.nextTestStep("Click on [...] from menu bar ")
	...
	gAct.Wait(2)
	WebUI.dragAndDropToObject(findTestObject(Const.columnPicker + "col_Active"), findTestObject(Const.columnPicker + "col_Description"))
