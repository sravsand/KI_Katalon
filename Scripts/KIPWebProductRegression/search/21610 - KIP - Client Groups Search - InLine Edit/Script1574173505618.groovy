...
Rep.nextTestStep("Tick the checkbox from [Action] column")
	WebD.clickElement("//div[@id='f30ae4c8-6ace-4b45-9133-76408f71624d']/div[5]/table/tbody/tr[" + rowNo + "]/td[4]/div/label/span")
	gAct.Wait(1)
	
	
Rep.nextTestStep("Click on [Floppy Icon] to save the changes")
	WebD.clickElement("//div[@id='f30ae4c8-6ace-4b45-9133-76408f71624d']/div[5]/table/tbody/tr[" + rowNo + "]/td/div/a/i")
	gAct.Wait(1)
