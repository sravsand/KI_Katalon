...
Rep.nextTestStep("Click onto [Accept]")
	gObj.buttonClickSubIntPosSync(Const.columnPicker + "a_ViewInline", 1, "pos")
	
	
Rep.nextTestStep("Select [Accepted] from [Acceptance Status] dropdown menu")
	gObj.selectComboByLabelSync(Const.columnPicker + "select_ClaimAcces", "Accepted")
...
Rep.nextTestStep("Verify the status of the claim under [Acceptance] is change to [Accepted] ")
