...
Rep.nextTestStep("Click onto [Inline menu] of Mitigation Plan Items")
...
Rep.nextTestStep("Click on [Search] button and select a different [Type]")
	gObj.populateEditBox(Const.columnPicker + 'input_RiskActionType', newRiskType, Const.columnPicker + 'edt_DropSelect')
...
Rep.nextTestStep("Verify that the type has been changed to the value selected at step 5")
	String newType = gObj.getAttributeSync(Const.columnPicker + 'input_RiskActionType', 'value')
	gAct.compareStringAndReport(newType, newRiskType)
