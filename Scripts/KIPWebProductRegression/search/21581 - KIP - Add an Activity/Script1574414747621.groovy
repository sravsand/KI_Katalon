...
//pre-req: make sure that settings>Auto-Generate>Activities tab>untick Use Automated Activity Code
...
Rep.nextTestStep("Select [Activity] from dropdown list")
...
Rep.nextTestStep("Click on [Save] or [Save & Close] button")
	...
	gAct.compareStringAndReport(errorMsg, "Unable to Save Activity")
...
Rep.nextTestStep("Verify the newly added Expense Type is added onto the table")
	sVal.searchTableAddedValue(3, activity.name)
