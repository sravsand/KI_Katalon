...
String newTemplate = "Copy of TestAuto_Proj" + browser
...
Rep.nextTestStep("Log in to the environment under test")
	...
	Act.changeProjectLoop('All Company', 'Customer Projects', 'PSA Solutions Inc', 'Project Innovation')
...
Rep.nextTestStep("Click onto [Inline] menu of the login profile under test i.e PROJECT_MANAGER_STR and click [Open]")
	int rowNo = sVal.searchTableReturnRow(2, loginProfile)
...
Rep.nextTestStep("Select [Project Type] ")	
 ...
 Rep.nextTestStep("Select [Create Project from Template] Radio button - if Applicable")
	gObj.buttonClickSync(Const.templates + 'radio_CreateProjectFromTemplate')


Rep.nextTestStep("Select [Template] from the dropdown - if applicable ")
...
Rep.nextTestStep("Verify and Click onto [Option] Tab ")
