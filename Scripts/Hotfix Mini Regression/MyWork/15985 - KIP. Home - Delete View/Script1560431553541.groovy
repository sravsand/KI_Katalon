...
Rep.nextTestStep("Click [Save] button next to layout button")
	...
	boolean viewDeleted = WebUI.verifyElementNotPresent(findTestObject(Const.dashBoard + 'selectView', [('view'): myWorkView]), GVars.midWait, FailureHandling.CONTINUE_ON_FAILURE)	
	if(viewDeleted){
